                                        ...
                                        <div class="col s12 m8 l12">
                                            <table id="data-table-simple" class="responsive-table display" cellspacing="0">
                                                ...
                                                while ($res1 = mysqli_fetch_array($result1)) { ?>
                                                    ...
                                                    <td><a class="waves-effect waves-light modal-trigger light-blue btn" href="viewPOC.php?id=<?php echo $res['POCID']; ?>">View Details</a>
                                                    
                                                    <td><a class="waves-effect waves-light modal-trigger light-blue btn" href="editPOC.php?id=<?php echo $res['POCID']; ?>" >Update Record</a>
                                                    <?php } } ?>
                                                    </tr>
                                                </tbody>
                                            </table>
