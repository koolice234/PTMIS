                                        ...
                                        <table id="data-table-simple" class="responsive-table display" cellspacing="0">
                                            ...
                                            <tbody>
                                                ...
                                                while ($res1 = mysqli_fetch_array($result1)) { ?>
                                                    ...
                                                    <td><a class="waves-effect waves-light modal-trigger light-blue btn" href="viewEval.php?id=<?php echo $res['EvalID']; ?>">View Details</a>
                                                    
                                                    <td><a class="waves-effect waves-light modal-trigger light-blue btn" href="editEval.php?id=<?php echo $res['EvalID']; ?>" >Update Record</a>
