                            ...
                            <form class="col s12" action="evaluationActionAdd.php" method="post" >
                                <div class="row">
                                    ...
                                    <div class="input-field col s2">
                                        <input name="evalSession" type="number" required>
                                ...
                                <div class="card-panel">
                                    ...
                                    <div class="body">
                                        <div class="row">
                                            <div class="input-field col s4">
                                                <textarea name="Speech" class="materialize-textarea" required></textarea>
                                            ...
                                            <div class="input-field col s4">
                                                <textarea name="Endurance" class="materialize-textarea" required></textarea>
                                                <label for="Endurance">Endurance</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field col s4">
                                                <textarea name="Vision" class="materialize-textarea" required></textarea>
                                                <label for="Vision">Vision</label>
                                            </div>
                                            <div class="input-field col s4">
                                                <textarea name="MuscleTone" class="materialize-textarea" required></textarea>
                                        ...
                                        <div class="row">
                                            <div class="input-field col s4">
                                                <textarea name="Hearing" class="materialize-textarea" required></textarea>
                                                <label for="Hearing">Hearing</label>
                                            </div>
                                            <div class="input-field col s4">
                                                <textarea name="Coordination" class="materialize-textarea" required></textarea>
                            ...
                            <div class="card-panel">
                                ...
                                <div class="card-panel">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="input-field col s2">
                                            <a href="addevaluation.php" class="btn red waves-effect waves-light right" >Cancel</i></a>
                                        </div>
                                    </div>
                                </div>        
