                                    ...
                                    <div class="col s12">
                                        <div class="input-field col s8">
                                           <select name="training">
                                            <option  value="<?php echo $erow['POCTreatment']; ?>" disabled selected>Choose Training</option>
                                            <?php include("config.php");
                                        ...
                                        <div class="input-field col s2">
                                            <input name="sets" type="number" value="<?php echo $erow['POCSets']; ?>" min="1" max="30">
                                            <label for="sets">Sets</label>
                                        </div>
                                        <div class="input-field col s2">
                                            <input name="repetitions" value="<?php echo $erow['POCRepeatitions']; ?>" type="number" min="1" max="30">
