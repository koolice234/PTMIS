...
<?php include_once("config.php"); ?>  
                ...
                <div class="card-panel">
                    <div class="container">
                        <div class="section">
                            <a href="PatientRegistration.php" class="btn cyan waves-effect waves-light right" type="submit" name="Submit" value="add"><i class="mdi-content-add"></i>Add Patient</a>
                                            ...
                                            <table id="data-table-simple" class="responsive-table display" cellspacing="0">
                                                ...
                                                $result = mysqli_query($mysqli, "SELECT * FROM patient ORDER BY PatientID");
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="patientEdit.php?patient_id=<?php echo $res['PatientID']; ?>" data-toggle="modal" class="waves-effect waves-light modal-trigger light-blue btn"> Update </a>
                                                        </td>
                                                    </tr>
                                                    <?php } ?>
                                                </tbody>
