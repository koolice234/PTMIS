...
if(isset($_POST['Submit'])) {	
	...
	$sessionDate = date('Y-m-d');
		...
		$result = mysqli_query($mysqli,
			...
			"UPDATE planofcare SET PatientID = '$PatientID', POCPT = '$PTName',POCSessionDate = '$sessionDate',POCTreatment = '$training', POCRepeatitions = '$repetitions', POCSets ='$sets', POCBloodPressure = '$bloodPressure', POCHeartRate ='$heartRate' , POCRespiratoryRate = '$respiratoryRate', POCPulse = '$pulse', POCAssessment = '$assessment', POCPlan = '$plan', POCNextSchedDate ='$nextSchedDate1' , POCTreatmentBill = '$billing', POCTime = '$time', POCStatus = 'Unpaid', POC_Subjective = '$subjective' WHERE POCID = '$id'");
