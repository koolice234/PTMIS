                                ...
                                <div class="row">
                                    <div class="col s12">
                                        ...
                                        <div class="input-field col s2">
                                            <input name="sets"  value="<?php echo $erow['POCSets']; ?>" type="number" min="1" max="30" disabled style="color: black;">
                                            <label for="sets" style="color: black;">Sets</label>
                                        </div>
                                        <div class="input-field col s2">
                                            <input name="repetitions" value="<?php echo $erow['POCRepeatitions']; ?>" type="number" min="1" max="30" disabled style="color: black;">
                                            <label for="repetitions"style="color: black;" >Repetitions</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="divider"></div>
